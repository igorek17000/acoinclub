...
<div class="footer-sub-con">
    ...
    <div class="footer-information">
        ...
        <div class="service-list">
            ...
            <p class="serv-list w3-hover-text-light-blue">
                <a href="./signup" class="w3-hover-text-light-blue"> Getting Started </a>
            </p>
            <p class="serv-list w3-hover-text-light-blue">
    ...
    <div class="footer-about">
        ...
        <div class="service-list">
            ...
            <p class="serv-list w3-hover-text-light-blue">
                <a href="./signup" class="w3-hover-text-light-blue"> Refund Policy </a>
            </p>
            <p class="serv-list w3-hover-text-light-blue">
    ...
    <div class="footer-follow">
        ...
        <div class="service-list">
            ...
            <button type="submit" class="divflexxbuttmaxx">Acoinclub Status</button>
            <br>
...
<div class="bottomfoot">
    <div class="bottomfoot-min">
        <div class="fooma">
            <div class="fooma-l"> Acoinclub LTD, Acoinclub Corp. and Acoinclub Limited are collectively managing the Platform.</div>
        ...
        <p>
            Acoinclub Corp. serves United States residents only in jurisdictions where it is licensed to operate.
        </p>
        <p>
            Acoinclub Limited serves companies from the European Union and is regulated by the Gibraltar Financial Services Commission as a DLT Provider under the authorization number: FSC1345B.
        </p>

        <p>
            Acoinclub LTD serves residents throughout countries all over the world in which it operates.
        </p>
        <p>
            Acoinclub Overseas LTD provides technical support for Users from the list countries prescribed by Acoinclub’s <a href="#">Terms of Use</a>.
        </p>
