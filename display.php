            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                            <label class="display" style="color: green;" id="btcperc"><?php echo $res["price_change_percentage_24h"]; ?></label>
                        <?php

                        } else {
                        ?>
                            <label class="display" style="color: red;" id="btcperc"><?php echo $res["price_change_percentage_24h"]; ?></label>
                        <?php
                        }
                    ...
                    <td>
                        <button class="w3-button w3-border w3-light-blue w3-round-large w3-hover-blue" id="register">Buy</button>
                    </td>
                </tr>
