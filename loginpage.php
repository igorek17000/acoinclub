...
use Google\Client\setAuthConfig;

$clientID = "767950210192-1sa950ja845v2dt90m41442habhui9bb.apps.googleusercontent.com";
$clientSecret = "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";
$redirectUri = MYURL . "loginpage.php";
...
if (isset($_GET['code']) and !empty($_GET['code'])) {
    ...
    if ($isActive == true) {
        ...
        $_SESSION["USER"] = DataBase::get_CurrentUser($id);
    } else {
        ...
        if ($valu == true) {
            ...
            $message = "Can not Create User Contact support";
        }
    }
}
